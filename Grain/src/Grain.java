...
public class Grain {
    ...
    /**
    * Esta función se llama cuando el objeto está destinado y hace dos cosas:
    * Primero:
    * Convierta el IV en una cadena binaria y luego divídalo por bit en un índice 
    * en la matriz LFSR.
	* Segundo:
	* convierte KEY en una cadena binaria y la separa por bit en un índice 
	* en la matriz NFSR.
     * @param iv
     * @param key 
     */
    public void init(String iv, String key) {
        ...
        // llenar el índice de 64 a 80 con un valor de 1
        for (int i = 64; i < 80; i++) {
            lfsr[i] = 1;
        }
    ...
    public void lfsr() {
        ...
        for (int i = 1; i <= 160; i++) {
            // calcular xor basado en el cálculo en grano
            ...
            // deslice la matriz de 1 posición en sentido horario
    ...
    public void nfsr() {
        ...
        for (int i = 1; i < 161; i++) {
            // calcular xor basado en cálculos en grain
            ...
            List<Byte> data_list = Arrays.asList(data);
            // conjunto de diapositivas 1 posición en sentido horario
            Collections.rotate(data_list, 1);
    ...
    /**
     * La función de filtro se utiliza para generar keystream
     * @return String
     */
    public String filter() {
        ...
        this.nfsr();
        // definir la variable de cálculo xor
